...
if __name__ == "__main__":
	...
	parser.add_argument('--cmudictraw', default="cmudict.rep", help="The raw cmudict file to use (.rep expected); only necessary if no cmudictdb given")
	parser.add_argument('--phonemecsv', default="phoneme_roundness.csv", help="The path to the .csv file containing phoneme roundness scores")
